...
# The code above is copied *as is* from the Accelerate NLP example:
...
if __name__ == "__main__":
    ...
    training_function_gpu = rh.send(fn=training_function,
                                    hardware=gpu,
                                    reqs=['./', 'evaluate', 'scipy', 'scikit-learn'],
    ...
    main = rh.send('https://github.com/huggingface/diffusers/blob/main/examples/dreambooth/train_dreambooth.py:main')

    reqs.append('https://github.com/huggingface/diffusers/')
    fn_pointers = ('diffusers/blob/main/examples/dreambooth', 'train_dreambooth', 'main')